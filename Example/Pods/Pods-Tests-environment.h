...
#define COCOAPODS_POD_AVAILABLE_VMCompositeDataSources
#define COCOAPODS_VERSION_MAJOR_VMCompositeDataSources 0
#define COCOAPODS_VERSION_MINOR_VMCompositeDataSources 1
#define COCOAPODS_VERSION_PATCH_VMCompositeDataSources 0
